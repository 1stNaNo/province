...
$(document).ready(function() {
	...
	$('#quick-access .btn-cancel').click( function() {
		$("#quick-access").css("bottom","-10000px");
    });
...
function fnFormatDetails ( oTable, nTr )
{
    ...
    sOut += '<tr><td>Үйлдвэрлэсэн он:</td><td>'+aData[1]+' '+aData[4]+'</td></tr>';
    sOut += '<tr><td>Хадгалах хугацаа:</td><td>Could provide a link here</td></tr>';
    sOut += '<tr><td>Нийлүүлэгч байгууллага:</td><td>And any further details here (images etc)</td></tr>';
    sOut += '</table>';
