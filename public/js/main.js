...
(function(){
    ...
    filters.on('click', 'asd', function(e) {
        e.preventDefault();
        var el = $(this);
...
$(document).ready(function(){
  ...
  for(var i=0; i < basicMenuObj.length; i++){
      ...
      if(basicMenuObj[i].parent_id == 0){
          $('.main-nav-list.sf-menu').append('<li menuid="'+ basicMenuObj[i].ca_id +'"><a isparent="true" target_="'+ basicMenuObj[i].target +'" href="'+ tmpUrl +'">'+ basicMenuObj[i].source +'</a></li>');
      }else{
          var tmpItem = $('.main-nav-list.sf-menu').find("li[menuid='"+ basicMenuObj[i].parent_id +"']");
      ...
      if(basicMenuObj[i].parent_id == 0){
          $('#ammenu').append('<li class="am-item" menuid="'+ basicMenuObj[i].ca_id +'"><a isparent="true" target_="'+ basicMenuObj[i].target +'" href="'+ tmpUrl +'">'+ basicMenuObj[i].source +'</a></li>');
      }else{
          var tmpItem = $('#ammenu').find("li[menuid='"+ basicMenuObj[i].parent_id +"']");

          if($(tmpItem).find("ul.usubmenu").length <= 0){
              $(tmpItem).append('<ul class="am-list usubmenu"></ul>');

              $(tmpItem).find("ul.usubmenu").append('<li class="am-item" menuid="'+ basicMenuObj[i].ca_id +'"><a target_="'+ basicMenuObj[i].target +'" href="'+ tmpUrl +'">'+ basicMenuObj[i].source +'</a></li>');
          }else{
              $(tmpItem).find("ul.usubmenu").append('<li class="am-item" menuid="'+ basicMenuObj[i].ca_id +'"><a target_="'+ basicMenuObj[i].target +'" href="'+ tmpUrl +'">'+ basicMenuObj[i].source +'</a></li>');
          }
      }
      ...
      if(basicMenuObj[i].parent_id == 0){
          $('#mbmenu').append('<li class="mn-item" menuid="'+ basicMenuObj[i].ca_id +'"><a isparent="true" target_="'+ basicMenuObj[i].target +'" href="'+ tmpUrl +'">'+ basicMenuObj[i].source +'</a></li>');
      }else{
          var tmpItem = $('#mbmenu').find("li[menuid='"+ basicMenuObj[i].parent_id +"']");

          if($(tmpItem).find("ul.usubmenu").length <= 0){
              $(tmpItem).append('<ul class="usubmenu"></ul>');

              $(tmpItem).find("ul.usubmenu").append('<li class="mn-item" menuid="'+ basicMenuObj[i].ca_id +'"><a target_="'+ basicMenuObj[i].target +'" href="'+ tmpUrl +'">'+ basicMenuObj[i].source +'</a></li>');
          }else{
              $(tmpItem).find("ul.usubmenu").append('<li class="mn-item" menuid="'+ basicMenuObj[i].ca_id +'"><a target_="'+ basicMenuObj[i].target +'" href="'+ tmpUrl +'">'+ basicMenuObj[i].source +'</a></li>');
          }
      }
