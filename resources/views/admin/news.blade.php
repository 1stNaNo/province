...
<div id="window_newsList" class="page-window active-window">
        ...
        <table action="news/data" cellpadding="0" cellspacing="0" border="0" class="table table-hover table-condensed" id="news_grid" width="100%">
          <thead>
            <tr>
              ...
              <th>{{trans('resource.news.ca_title')}}</th>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        buttons.push('<button onclick="unews.edit()" class="btn btn-warning" style="margin-left:12px">{{trans('resource.buttons.edit')}}</button>');
        buttons.push('<button onclick="unews.remove()" class="btn btn-danger" style="margin-left:12px">{{trans('resource.buttons.remove')}}</button>');
     ...
     var unews = {
          ...
          edit: function(){
              ...
              postData['id'] = baseGridFunc.getSelectedRow('news_grid', 'id');
              if(postData['id'] != ""){
                  uPage.call('news/index',postData);
              }
          },
