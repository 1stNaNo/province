<footer class="main-footer">
    {{-- <div class="container">
            ...
            <div class="row">
                <div class="one-third sm-full">
                    <div class="ft-widget">
                        ...
                        <ul class="ft-list-1">
                            <li>
                                <h5 class="ft-title-2"><a href="">Altricies vehicula neque rhoncus ut</a></h5>
                                <div class="date">october 2, 2015</div>
                            </li>
                            <li>
                                <h5 class="ft-title-2"><a href="">Nulla porttitor bibendum viverra</a></h5>
                                <div class="date">october 2, 2015</div>
                            </li>
                            <li>
                                <h5 class="ft-title-2"><a href="">Ut a risus ut nisi auctor placerat sed non orci</a></h5>
                                <div class="date">october 2, 2015</div>
                            </li>
                            <li>
                                <h5 class="ft-title-2"><a href="">Quis gravida purus posuere sit amet</a></h5>
                                <div class="date">october 2, 2015</div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="one-third sm-full">
                    <div class="ft-widget">
                        ...
                        <ul class="ft-list-2">
                            <li>
                                <figure>
                                    <a href=""><img src="https://s3.amazonaws.com/weblionmedia-spectr/img/115x85/14.jpg" height="85" width="115" alt="Spectr News Theme"></a>
                                </figure>
                                <h5 class="ft-title-2"><a href="">Duis eu arcu sit amet ante tristique</a></h5>
                                <div class="date">october 2, 2015</div>
                            </li>
                            <li>
                                <figure>
                                    <a href=""><img src="https://s3.amazonaws.com/weblionmedia-spectr/img/115x85/15.jpg" height="85" width="115" alt="Spectr News Theme"></a>
                                </figure>
                                <h5 class="ft-title-2"><a href="">Vivamus auctor quam nec mauris commodo</a></h5>
                                <div class="date">october 2, 2015</div>
                            </li>
                            <li>
                                <figure>
                                    <a href=""><img src="https://s3.amazonaws.com/weblionmedia-spectr/img/115x85/16.jpg" height="85" width="115" alt="Spectr News Theme"></a>
                                </figure>
                                <h5 class="ft-title-2"><a href="">Nam ut metus elementum pharetra diam sed</a></h5>
                                <div class="date">october 2, 2015</div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="bottom-part">
            <div class="row">
                <div class="ft-logo">
                    <a href=""><img src="https://s3.amazonaws.com/weblionmedia-spectr/img/footer-logo.svg" height="30" width="105" alt="Spectr News Theme"></a>
                </div>
                <div class="ft-about">
                    <article>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ft-social">
                    <ul class="ft-social-list pull-right">
                        <li class="tw">
                            <a href="{{trans('resource.main.fblink')}}"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li class="fb">
                            <a href="{{trans('resource.main.twitterlink')}}"><i class="fa fa-facebook"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
